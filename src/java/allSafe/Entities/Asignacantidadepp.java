...
@NamedQueries({
    ...
    , @NamedQuery(name = "Asignacantidadepp.findDevolucion", query = "SELECT a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.idProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.numeroProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.nombreProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.idEPP,a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.nombreEPPcol,SUM(a.cantidadEppProceso) FROM Asignacantidadepp a GROUP BY a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.idProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.idEPP HAVING a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.idProyecto = :asignaeppaproyectoIdasignaeppaproyecto")
    , @NamedQuery(name = "Asignacantidadepp.findDevolucionXidXproy", query = "SELECT a.cantidadEppProceso FROM Asignacantidadepp a  WHERE (a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.idProyecto = :asignaeppaproyectoIdasignaeppaproyecto AND a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.idEPP = :asignaeppaproyectoIdasignaeppaproyecto2)")
    , @NamedQuery(name = "Asignacantidadepp.findReasignaci", query = "SELECT a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.idProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.numeroProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.proyectoidProyecto.nombreProyecto,a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.idEPP,a.asignaeppaproyectoIdasignaeppaproyecto.eppidEPP.nombreEPPcol, a.cantidadEppProceso FROM Asignacantidadepp a WHERE a.tipodecargaIdtipodecarga.idtipodecarga = :tipodecargaIdtipodecarga")
...
public class Asignacantidadepp implements Serializable {
    ...
    public Asignacantidadepp(Integer idEppProceso, String fechaCreacionEppProceso, String tallaEppProceso, int unidadEppProceso, Number cantidadEppProceso, int precioUnitarioEppProceso) {
        this.idEppProceso = idEppProceso;
